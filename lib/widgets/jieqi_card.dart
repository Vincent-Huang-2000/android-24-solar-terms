// lib/widgets/jieqi_card.dart
import 'package:flutter/material.dart';
import '../models/jieqi_model.dart';

class JieQiCard extends StatelessWidget {
  final JieQi jieQi;

  const JieQiCard({super.key, required this.jieQi});
